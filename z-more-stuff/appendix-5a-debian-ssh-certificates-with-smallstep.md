# Appendix 5a — SSH Certificates with Smallstep step-ca (Debian)
...
> **Note:** This lab is written for Debian 13. If using CentOS Stream 10, see Appendix 5b.
...
```bash
curl -k https://10.42.17.101:8443/health
```
...
```bash
until curl -sk https://10.42.17.101:8443/health | grep -q ok; do
...
```bash
step ca bootstrap \
  --ca-url https://10.42.17.101:8443 \
